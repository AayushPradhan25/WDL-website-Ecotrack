...
const API_BASE = 'https://eco-smart-backend-3km1.onrender.com';
        ...
        initLayout() {
            ...
            if (sidebar) {
                ...
                const adminMenu = [
                    ...
                    { icon: 'fa-map-location-dot', label: 'Driver Live Tracking', link: 'driver-live-tracking.html' },
                ...
                const userMenu = [
                    ...
                    { icon: 'fa-truck-alt', label: 'Nearby Trucks', link: 'live-truck-tracking.html' },
